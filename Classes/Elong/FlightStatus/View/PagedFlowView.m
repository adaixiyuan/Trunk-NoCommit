...
- (void)removeCellAtIndex:(NSInteger)index{
    UIView *cell = [_cells safeObjectAtIndex:index];
    ...
    switch (orientation) {
        case PagedFlowViewOrientationHorizontal:{
            ...
            for (int i = _visibleRange.location; i < _visibleRange.location + _visibleRange.length; i++) {
                UIView *cell = [_cells safeObjectAtIndex:i];
...
- (void)setPageAtIndex:(NSInteger)pageIndex{
    ...
    UIView *cell = [_cells safeObjectAtIndex:pageIndex];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if ([_delegate respondsToSelector:@selector(didScrollToPage:inFlowView:andPage:)] && _currentPageIndex != pageIndex) {
        [_delegate didScrollToPage:pageIndex inFlowView:self andPage:cell];
    }
