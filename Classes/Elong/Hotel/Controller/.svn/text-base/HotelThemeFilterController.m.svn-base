...
@interface HotelThemeFilterController (){
    UITableView *themeList;
    BOOL isall;
}
@end

@implementation HotelThemeFilterController
...
- (void)viewDidLoad{
    ...
    themeList = [[UITableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain];
    themeList.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleHeight;
    themeList.dataSource = self;
    themeList.separatorStyle = UITableViewCellSeparatorStyleNone;
    themeList.delegate = self;
    [self.view addSubview:themeList];
    [themeList release];
}
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [self.themeArray safeObjectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(hotelThemeFilterController:didSelectIndexs:)]) {
        [self.delegate hotelThemeFilterController:self didSelectIndexs:self.selectedIndexs];
    }
}
