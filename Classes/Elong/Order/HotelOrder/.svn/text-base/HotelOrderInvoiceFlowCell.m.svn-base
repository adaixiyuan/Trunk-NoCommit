...
@implementation HotelOrderInvoiceFlowCell
...
- (void)awakeFromNib
{
    ...
    _verticalLineImgView = [[UIImageView alloc] initWithFrame:CGRectMake(33, 0, SCREEN_SCALE, 50)];
