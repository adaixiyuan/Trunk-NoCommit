...
+ (NSString *)udid
{
	return [PublicMethods macaddress]; //return [Countly_OpenUDID value];
}
...
+ (NSString *)wirelessInternet{
    ...
    NSLog(@"%d",reachability.currentReachabilityStatus);
...
+ (NSString *)metrics
{
    ...
    [metricsDictionary setObject:CountlyDeviceInfo.appName forKey:@"_app_name"];
    [metricsDictionary setObject:CountlyDeviceInfo.wirelessInternet forKey:@"_wireless_internet"];
    [metricsDictionary setObject:COUNTLY_KEY forKey:@"_app_key"];
    [metricsDictionary setObject:[PublicMethods macaddress] forKey:@"_device_id"];
    [metricsDictionary setObject:@"1" forKey:@"_site"];
